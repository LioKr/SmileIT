...
@Component({
  selector: 'app-customer-opinion-average-between-two-date-form',
  templateUrl: './customer-opinion-average-between-two-date-form.component.html',
  styleUrls: ['./customer-opinion-average-between-two-date-form.component.scss']
})
export class CustomerOpinionAverageBetweenTwoDateFormComponent implements OnInit {
