...
namespace SmileIT.API.Controllers
{
    ...
    {
       private const string ConnectionString = @"Data Source=desktop-12fd2ha\sqlexpress;Initial Catalog=SmileITv3.DB;Integrated Security=True"; //lk connection string
